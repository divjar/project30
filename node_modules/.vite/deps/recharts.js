import {
  ...
  wiggle_default,
  wye_default
} from "./chunk-KSMILE7Q.js";
import {
  TransitionGroup_default,
  Transition_default
} from "./chunk-ITTOZUMZ.js";
import "./chunk-3IHV7RO6.js";
import {
  clsx_default,
  init_clsx
} from "./chunk-OQ5ILIMD.js";
import {
  require_prop_types
...
var AnimateGroupChild = function(_Component) {
  ...
  function AnimateGroupChild2() {
    ...
    _defineProperty21(_assertThisInitialized7(_this), "handleEnter", function(node, isAppearing) {
      var _this$props = _this.props, appearOptions = _this$props.appearOptions, enterOptions = _this$props.enterOptions;
      _this.handleStyleActive(isAppearing ? appearOptions : enterOptions);
    });
    _defineProperty21(_assertThisInitialized7(_this), "handleExit", function() {
  ...
  return _createClass12(Radar2, [{
    ...
    value: function renderDotItem(option, props) {
      ...
      if (import_react33.default.isValidElement(option)) {
        ...
        dotItem = import_react33.default.createElement(Dot, _extends22({}, dotProps, {
          key,
  ...
  return _createClass13(RadialBar2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        return import_react35.default.createElement(RadialBarSector, _extends24({}, props, {
          key: "sector-".concat(i)
        }));
      });
    }
...
var Brush = function(_PureComponent) {
  ...
  return _createClass14(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, import_react36.default.createElement(Text, _extends25({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y + height / 2
      }, attrs), this.getTextOfTick(startIndex)), import_react36.default.createElement(Text, _extends25({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function BarRectangle(props) {
  return import_react37.default.createElement(Shape, _extends26({
    shapeType: "rectangle",
  ...
  return _createClass15(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        return import_react38.default.createElement(Layer, _extends27({
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return import_react38.default.createElement(BarRectangle, _extends27({
...
var renderLine = function renderLine2(option, props) {
  ...
  if (import_react40.default.isValidElement(option)) {
    ...
    line = import_react40.default.createElement("line", _extends28({}, props, {
...
var ReferenceLine = function(_React$Component) {
  ...
  return _createClass17(ReferenceLine2, [{
    key: "render",
    value: function render() {
      return import_react40.default.createElement(ReferenceLineImpl, this.props);
    }
  }]);
...
_defineProperty39(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (import_react41.default.isValidElement(option)) {
    ...
    dot = import_react41.default.createElement(Dot, _extends29({}, props, {
      cx: props.cx,
      cy: props.cy,
...
_defineProperty40(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (import_react42.default.isValidElement(option)) {
    ...
    rect = import_react42.default.createElement(Rectangle, _extends30({}, props, {
...
var CartesianAxis = function(_Component) {
  ...
  return _createClass20(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return import_react43.default.createElement("line", _extends31({}, props, {
    ...
    value: (
      ...
      function renderTicks(ticks, fontSize, letterSpacing) {
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          return import_react43.default.createElement(Layer, _extends31({
            className: "recharts-cartesian-axis-tick",
            key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && import_react43.default.createElement("line", _extends31({}, tickLineProps, lineCoord, {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (import_react43.default.isValidElement(option)) {
        ...
        tickItem = import_react43.default.createElement(Text, _extends31({}, props, {
...
function renderLineItem(option, props) {
  ...
  if (import_react44.default.isValidElement(option)) {
    ...
    lineItem = import_react44.default.createElement("line", _extends32({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  }), import_react44.default.createElement(HorizontalGridLines, _extends32({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), import_react44.default.createElement(VerticalGridLines, _extends32({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), import_react44.default.createElement(HorizontalStripes, _extends32({}, propsIncludingDefaults, {
    horizontalPoints
  })), import_react44.default.createElement(VerticalStripes, _extends32({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
var Line = function(_PureComponent) {
  ...
  return _createClass21(Line2, [{
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      ...
      return import_react45.default.createElement(Curve, _extends33({}, curveProps, {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (import_react45.default.isValidElement(option)) {
        ...
        dotItem = import_react45.default.createElement(Dot, _extends33({
          key
        }, dotProps, {
          className
        }));
...
var Area = function(_PureComponent) {
  ...
  return _createClass22(Area2, [{
    ...
    value: function renderDots(needClip, clipDot, clipPathId) {
      ...
      return import_react46.default.createElement(Layer, _extends34({
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      ...
      return import_react46.default.createElement(Layer, {
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null
      }, import_react46.default.createElement(Curve, _extends34({}, filterProps(others, true), {
        points,
        connectNulls,
        type,
        baseLine,
      ...
      })), stroke !== "none" && import_react46.default.createElement(Curve, _extends34({}, filterProps(this.props, false), {
        ...
        fill: "none",
        points
      })), stroke !== "none" && isRange && import_react46.default.createElement(Curve, _extends34({}, filterProps(this.props, false), {
        className: "recharts-area-curve",
        layout,
        type,
        connectNulls,
...
_defineProperty45(Area, "renderDotItem", function(option, props) {
  ...
  if (import_react46.default.isValidElement(option)) {
    ...
    dotItem = import_react46.default.createElement(Dot, _extends34({}, rest, {
      key,
      className
    }));
  }
...
function ScatterSymbol(_ref) {
  ...
  if (typeof option === "string") {
    return import_react48.default.createElement(Shape, _extends35({
      option: import_react48.default.createElement(Symbols, _extends35({
        type: option
      }, props)),
      isActive,
      shapeType: "symbols"
  ...
  return _createClass24(Scatter2, [{
    ...
    value: function renderSymbolsStatically(points) {
      ...
      return points.map(function(entry, i) {
        ...
        return import_react49.default.createElement(Layer, _extends36({
          className: "recharts-scatter-symbol",
          key: "symbol-".concat(entry === null || entry === void 0 ? void 0 : entry.cx, "-").concat(entry === null || entry === void 0 ? void 0 : entry.cy, "-").concat(entry === null || entry === void 0 ? void 0 : entry.size, "-").concat(i)
        }, adaptEventsOfChild(_this2.props, entry, i), {
          role: "img"
        }), import_react49.default.createElement(ScatterSymbol, _extends36({
          option,
          isActive,
          key: "symbol-".concat(i)
        }, props)));
    ...
    value: function renderSymbolsWithAnimation() {
      ...
      var prevPoints = this.state.prevPoints;
      return import_react49.default.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
        ...
        return import_react49.default.createElement(Layer, null, _this3.renderSymbolsStatically(stepData));
      });
    }
  }, {
    key: "renderSymbols",
    ...
    value: function renderErrorBar() {
      ...
      return errorBarItems.map(function(item, i) {
        ...
        return import_react49.default.cloneElement(item, {
    ...
    value: function renderLine3() {
      ...
      if (import_react49.default.isValidElement(line)) {
        lineItem = import_react49.default.cloneElement(line, lineProps);
      } else if ((0, import_isFunction25.default)(line)) {
        lineItem = line(lineProps);
      } else {
        lineItem = import_react49.default.createElement(Curve, _extends36({}, lineProps, {
          type: lineJointType
        }));
      }
    ...
    value: function render() {
      ...
      return import_react49.default.createElement(Layer, {
        className: layerClass,
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null
      }, needClipX || needClipY ? import_react49.default.createElement("defs", null, import_react49.default.createElement("clipPath", {
        id: "clipPath-".concat(clipPathId)
      }, import_react49.default.createElement("rect", {
        x: needClipX ? left : left - width / 2,
        y: needClipY ? top : top - height / 2,
        width: needClipX ? width : width * 2,
        height: needClipY ? height : height * 2
      }))) : null, line && this.renderLine(), this.renderErrorBar(), import_react49.default.createElement(Layer, {
...
var XAxis = function(_React$Component) {
  ...
  return _createClass25(XAxis2, [{
    key: "render",
    value: function render() {
      return import_react50.default.createElement(XAxisImpl, this.props);
    }
  }]);
...
var YAxisImpl = function YAxisImpl2(_ref) {
  ...
  return (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    import_react51.default.createElement(CartesianAxis, _extends38({}, axisOptions, {
      className: clsx_default("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
      viewBox: {
        x: 0,
        y: 0,
...
var YAxis = function(_React$Component) {
  ...
  return _createClass26(YAxis2, [{
    key: "render",
    value: function render() {
      return import_react51.default.createElement(YAxisImpl, this.props);
    }
  }]);
...
function Cursor(props) {
  ...
  return (0, import_react52.isValidElement)(elementPropsCursor) ? (0, import_react52.cloneElement)(elementPropsCursor, cursorProps) : (0, import_react52.createElement)(cursorComp, cursorProps);
}
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var CategoricalChartWrapper = function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      _defineProperty52(_this, "renderCursor", function(element) {
        ...
        return import_react53.default.createElement(Cursor, {
          key,
          activeCoordinate,
          activePayload,
          activeTooltipIndex,
      ...
      _defineProperty52(_this, "renderPolarAxis", function(element, displayName, index) {
        ...
        return (0, import_react53.cloneElement)(element, _objectSpread46(_objectSpread46({}, axisOption), {}, {
      ...
      _defineProperty52(_this, "renderLegend", function() {
        ...
        return (0, import_react53.cloneElement)(item, _objectSpread46(_objectSpread46({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty52(_this, "renderTooltip", function() {
        ...
        return (0, import_react53.cloneElement)(tooltipItem, {
      ...
      _defineProperty52(_this, "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = (0, import_react53.cloneElement)(element, _objectSpread46(_objectSpread46({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [(0, import_react53.cloneElement)(element, _objectSpread46(_objectSpread46(_objectSpread46({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
            ...
            return [(0, import_react53.cloneElement)(xyItem, elementProps), null, null];
          }
        }
        if (isRange) {
      ...
      _defineProperty52(_this, "renderCustomized", function(element, displayName, index) {
        return (0, import_react53.cloneElement)(element, _objectSpread46(_objectSpread46({
    ...
    return _createClass28(CategoricalChartWrapper2, [{
      ...
      value: function renderClipPath() {
        ...
        return import_react53.default.createElement("defs", null, import_react53.default.createElement("clipPath", {
          id: clipPathId
      ...
      value: function render() {
        ...
        if (compact) {
          return import_react53.default.createElement(ChartLayoutContextProvider, {
            state: this.state,
        ...
        return import_react53.default.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, import_react53.default.createElement("div", _extends39({
  ...
  _defineProperty52(CategoricalChartWrapper, "renderActiveDot", function(option, props, key) {
    var dot;
    if ((0, import_react53.isValidElement)(option)) {
      dot = (0, import_react53.cloneElement)(option, props);
    } else if ((0, import_isFunction26.default)(option)) {
      dot = option(props);
    } else {
      dot = import_react53.default.createElement(Dot, props);
    }
  ...
  var CategoricalChart = (0, import_react53.forwardRef)(function CategoricalChart2(props, ref) {
    return import_react53.default.createElement(CategoricalChartWrapper, _extends39({}, props, {
      ref
    }));
  });
  ...
  return _createClass29(Treemap2, [{
    ...
    value: function renderItem(content, nodeProps, isLeaf) {
      ...
      if (!isAnimationActive) {
        return import_react54.default.createElement(Layer, event, this.constructor.renderContentItem(content, _objectSpread47(_objectSpread47({}, nodeProps), {}, {
          isAnimationActive: false,
          isUpdateAnimationActive: false,
          width,
          height,
      ...
      return import_react54.default.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
        ...
        return import_react54.default.createElement(es6_default, {
          ...
          isActive: isAnimationActive,
          duration: animationDuration
        }, import_react54.default.createElement(Layer, event, function() {
    ...
    value: function renderNestIndex() {
      ...
      return import_react54.default.createElement("div", {
        ...
        var content = null;
        if (import_react54.default.isValidElement(nestIndexContent)) {
          content = import_react54.default.cloneElement(nestIndexContent, item, i);
        }
    ...
    value: function render() {
      ...
      var _this$props11 = this.props, width = _this$props11.width, height = _this$props11.height, className = _this$props11.className, style = _this$props11.style, children = _this$props11.children, type = _this$props11.type, others = _objectWithoutProperties28(_this$props11, _excluded35);
      var attrs = filterProps(others, false);
      return import_react54.default.createElement("div", {
        className: clsx_default("recharts-wrapper", className),
    ...
    value: function renderContentItem(content, nodeProps, type, colorPanel) {
      if (import_react54.default.isValidElement(content)) {
        return import_react54.default.cloneElement(content, nodeProps);
      }
      ...
      if (width > 10 && height > 10 && nodeProps.children && type === "nest") {
        arrow = import_react54.default.createElement(Polygon, {
          points: [{
            x: x + 2,
            y: y + height / 2
          }, {
      ...
      if (width > 20 && height > 20 && nameSize.width < width && nameSize.height < height) {
        text = import_react54.default.createElement("text", {
          x: x + 8,
          y: y + height / 2 + 7,
          fontSize: 14
        }, nodeProps.name);
      ...
      return import_react54.default.createElement("g", null, import_react54.default.createElement(Rectangle, _extends40({
  ...
  return _createClass30(Sankey2, [{
    ...
    value: function renderLinks(links, nodes) {
      ...
      return import_react55.default.createElement(Layer, {
        ...
        return import_react55.default.createElement(Layer, _extends41({
    ...
    value: function render() {
      ...
      var _this$props7 = this.props, width = _this$props7.width, height = _this$props7.height, className = _this$props7.className, style = _this$props7.style, children = _this$props7.children, others = _objectWithoutProperties29(_this$props7, _excluded36);
    ...
    value: function renderLinkItem(option, props) {
      if (import_react55.default.isValidElement(option)) {
        return import_react55.default.cloneElement(option, props);
      }
      ...
      return import_react55.default.createElement("path", _extends41({
    ...
    value: function renderNodeItem(option, props) {
      ...
      return import_react55.default.createElement(Rectangle, _extends41({
...
var SunburstChart = function SunburstChart2(_ref) {
  ...
  var _useState = (0, import_react56.useState)(false), _useState2 = _slicedToArray14(_useState, 2), isTooltipActive = _useState2[0], setIsTooltipActive = _useState2[1];
  var _useState3 = (0, import_react56.useState)(null), _useState4 = _slicedToArray14(_useState3, 2), activeNode = _useState4[0], setActiveNode = _useState4[1];
  ...
  function drawArcs(childNodes, options) {
    ...
    childNodes.forEach(function(d) {
      ...
      sectors.push(
        ...
        import_react56.default.createElement("g", {
          "aria-label": d.name,
          tabIndex: 0
        }, import_react56.default.createElement(Sector, {
          ...
          cx,
          cy
        }), import_react56.default.createElement(Text, _extends42({}, textOptions, {
          alignmentBaseline: "middle",
          textAnchor: "middle",
          x: textX + cx,
          y: cy - textY
  ...
  function renderTooltip() {
    ...
    return import_react56.default.cloneElement(tooltipComponent, {
      viewBox,
  ...
  return import_react56.default.createElement("div", {
    ...
    role: "region"
  }, import_react56.default.createElement(Surface, {
    width,
    height
  }, children, import_react56.default.createElement(Layer, {
    className: layerClass
...
function FunnelTrapezoid(props) {
  return import_react57.default.createElement(Shape, _extends43({
    shapeType: "trapezoid",
  ...
  return _createClass31(Funnel2, [{
    ...
    value: function renderTrapezoidsStatically(trapezoids) {
      ...
      return trapezoids.map(function(entry, i) {
        ...
        return import_react58.default.createElement(Layer, _extends44({
          className: "recharts-funnel-trapezoid"
        }, adaptEventsOfChild(_this2.props, entry, i), {
          key: "trapezoid-".concat(entry === null || entry === void 0 ? void 0 : entry.x, "-").concat(entry === null || entry === void 0 ? void 0 : entry.y, "-").concat(entry === null || entry === void 0 ? void 0 : entry.name, "-").concat(entry === null || entry === void 0 ? void 0 : entry.value),
          role: "img"
        }), import_react58.default.createElement(FunnelTrapezoid, _extends44({
    ...
    value: function renderTrapezoidsWithAnimation() {
      ...
      return import_react58.default.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
        ...
        return import_react58.default.createElement(Layer, null, _this3.renderTrapezoidsStatically(stepData));
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return import_react58.default.createElement(Layer, {
        className: layerClass
